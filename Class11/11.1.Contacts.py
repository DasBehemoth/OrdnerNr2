class Contact:
    ...
    def print_contacts(self):
        return self.first_name + " " + self.last_name + " was born in " + self.birth_year + " (Phone Number: " + self.phone_number + " E-Mail: " + self.email + ")"
...
def main():
    ...
    clarissa = Contact(first_name="Clarissa", last_name="Mayer", phone_number="83483204032", birth_year="1978", email="marissa@yahoo.com")
    ruben = Contact(first_name="Ruben", last_name="Rauber", phone_number="42 42 42", birth_year="1969", email="ruben.rauber@yandex.ru")
    contacts = [john, clarissa, ruben]

    print "Your Contacts: "
    print ""

    for person in contacts:
        print person.print_contacts()
